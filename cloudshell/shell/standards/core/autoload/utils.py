...
class AutoloadDetailsBuilder:
    ...
    def _get_relative_address(self, resource: AbstractResource) -> str:
        ...
        if not addr:
            # resource can have different name
            name = ex_res.get_full_name_by_unique_id(resource.unique_identifier) or ""
            if name.casefold() == resource.full_name.casefold():
                addr = ex_res.get_address(name)
