...
class GenericSnmpConfig(GenericResourceConfig):
    snmp_read_community = PasswordAttrRO(attribute_names.SNMP_READ_COMMUNITY, ResourceAttrRO.NAMESPACE.SHELL_NAME)
    snmp_write_community = PasswordAttrRO(attribute_names.SNMP_WRITE_COMMUNITY, ResourceAttrRO.NAMESPACE.SHELL_NAME)
    snmp_v3_user = ResourceAttrRO(attribute_names.SNMP_V3_USER, ResourceAttrRO.NAMESPACE.SHELL_NAME)
    snmp_v3_password = PasswordAttrRO(attribute_names.SNMP_V3_PASSWORD, ResourceAttrRO.NAMESPACE.SHELL_NAME)
...
class GenericCLIConfig(GenericResourceConfig):
    ...
    password = PasswordAttrRO(attribute_names.PASSWORD, ResourceAttrRO.NAMESPACE.SHELL_NAME)
    enable_password = PasswordAttrRO(attribute_names.ENABLE_PASSWORD, ResourceAttrRO.NAMESPACE.SHELL_NAME)
...
class GenericConsoleServerConfig(GenericResourceConfig):
    ...
    console_password = PasswordAttrRO(attribute_names.CONSOLE_PASSWORD, ResourceAttrRO.NAMESPACE.SHELL_NAME)
...
class GenericBackupConfig(GenericResourceConfig):
    ...
    backup_password = PasswordAttrRO(attribute_names.BACKUP_PASSWORD, ResourceAttrRO.NAMESPACE.SHELL_NAME)
