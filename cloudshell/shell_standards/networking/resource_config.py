...
from cloudshell.shell_standards.core.resource_config_entities import GenericConfigContainer, ResourceAttrRO
import cloudshell.shell_standards.attribute_names as attribute_names


class NetworkingResourceConfig(GenericConfigContainer):
    ...
    power_management = ResourceAttrRO(attribute_names.POWER_MANAGEMENT, ResourceAttrRO.NAMESPACE.SHELL_NAME)
